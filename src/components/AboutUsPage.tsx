...
const AboutUsPage = () => {
    return (
        <Container className={styles.aboutUsPage}>
            <Container>
                <h1>FENDER MUSICAL INSTRUMENTS CORPORATION</h1>
                <h4>THE WORLD'S LEADING GUITAR MANUFACTURER</h4>
                <React.Fragment><br/></React.Fragment>
            </Container>
            <Container>
                <Row>
                    <Col><h1>Synonymous with all things rock 'n' roll</h1>
                        <h5>Today, FMIC brands include Fender®, Squier®, Gretsch®, Jackson®, Charvel® and EVH® among others.</h5>
            ...
            <Container>
                ...
                <h1>Our History</h1>
                <Row>
                    <Col>Fender Musical Instruments Corporation is the world’s foremost manufacturer of guitars, basses, amplifiers and related equipment.
                        ...
                        To “re-invent” Fender, CBS recruited new management in 1981. William Schultz became company president, supported by associate William Mendello.</Col>
                    <Col>Their 5-year business plan was based on increasing Fender’s marketplace presence with dramatic quality improvement and greater commitment to research and development.
                        ...
                        For more information, contact Fender Musical Instruments Corporation, 17600 N. Perimeter Drive, Suite 100 Scottsdale, AZ 85255, 480.596.9690</Col>
                </Row>
            ...
            <Container className={styles.image}>
                <React.Fragment><br/></React.Fragment>
            <h1>FENDER ARTISTS</h1>
                <img src="/img/aboutus2.jpg" className={styles.image}/>
                <img src="/img/aboutus3.jpg" className={styles.image}/>
                <img src="/img/aboutus4.jpg" className={styles.image}/>
                <img src="/img/aboutus5.jpg" className={styles.image}/>
                <img src="/img/aboutus6.jpg" className={styles.image}/>
                <img src="/img/aboutus7.jpg" className={styles.image}/>
                <img src="/img/aboutus8.jpg" className={styles.image}/>
                <img src="/img/aboutus9.jpg" className={styles.image}/>
            </Container>
        </Container>
    );
};
